\chapter{Instalación}
  ...
  \section{Para uso de la librería (compilado)}\label{sec:compiledinstall}
    ...
    La librería existe como un archivo .jar, se puede descargar desde la página creada para su difusión \url{http://hugoredon.github.io/Materia/}, o desde la página de búsqueda de Maven \url{http://search.maven.org/} con el nombre de la librería.
