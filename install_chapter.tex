\chapter{Instalación}
  ...
  \section{Para uso de la librería (compilado)}\label{sec:compiledinstall}
    ...
    Descargar el archivo .jar y agregarlo al folder /lib de la aplicación ó desde maven utilizando el archivo pom.xml \footnote{El archivo pom.xml contiene información y configuración sobre los proyectos java construidos por Maven y es la base de trabajo que usa Maven. Para mas información consultar la página \url{http://maven.apache.org/guides/introduction/introduction-to-the-pom.html}}.

    La librería existe como un archivo .jar, se puede descargar desde la página creada para su difusión \url{http://hugoredon.github.io/Materia/}, o desde la página de búsqueda de Maven \url{http://search.maven.org/} con el nombre de la librería 'Materia'.
