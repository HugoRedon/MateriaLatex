\subsection{Presión de Burbuja}\label{subsec:bubblepressure}
	...
	El cálculo de presión de burbuja se realiza como se indica en el código \ref{lst:bubblepressure}.
...
\begin{figure}
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Diagramas de presión de burbuja para el sistema metanol-agua.}\label{fig:bubblepressure3d}
\end{figure}
