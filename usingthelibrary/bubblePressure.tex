...
\centering
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Diagramas tridimensionales de presión-composición-temperatura para el sistema metanol-agua. Los diagramas son la misma figura vista desde diferentes angulos}\label{fig:bubblepressure3d}
\end{figure}
